...
/**
 * Copyright(c) of 2011-2013 Tang Ke
 * Credit to http://www.github.com/TangKe/TKSlideMenu
 ...
 *
 */
public class TKScrollDetectors {
	...
	private static class HorizontalScrollViewScrollDetector implements ScrollDetector {
		...
		public boolean canScrollHorizontal(View v, int direction) {
			...
			// Without scroll wrapper, can'trag_trx scroll
